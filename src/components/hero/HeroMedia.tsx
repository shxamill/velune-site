...
export function HeroMedia() {
  return (
    <>
      ...
      <div className="orbit-item orbit-item-1 absolute z-10 hidden md:block" style={{ top: '15%', left: '12%' }}>
      ...
      <div className="orbit-item orbit-item-3 absolute z-20 hidden md:block" style={{ top: '48%', left: '5%' }}>
      ...
      <div className="orbit-item orbit-item-5 absolute z-10 hidden lg:block" style={{ bottom: '15%', left: '22%' }}>
        <div className="orbit-item-inner relative w-[140px] lg:w-[160px] xl:w-[180px] rounded-xl overflow-hidden shadow-[0_20px_45px_-12px_rgba(20,20,19,0.15)] bg-surface-cream">
      ...
      {/* Item 2: Upper-Right */}
      <div className="orbit-item orbit-item-2 absolute z-10 hidden lg:block" style={{ top: '10%', right: '10%' }}>
        <div className="orbit-item-inner relative w-[140px] lg:w-[160px] xl:w-[180px] rounded-xl overflow-hidden shadow-[0_20px_45px_-12px_rgba(20,20,19,0.15)] bg-surface-cream">
          <div className="relative aspect-[3/4] overflow-hidden bg-secondary-container/40">
            <Image 
      ...
      {/* Item 4: Lower-Right */}
      <div className="orbit-item orbit-item-4 absolute z-10 hidden md:block" style={{ bottom: '20%', right: '12%' }}>
        <div className="orbit-item-inner relative w-[160px] lg:w-[180px] xl:w-[200px] rounded-xl overflow-hidden shadow-[0_20px_45px_-12px_rgba(20,20,19,0.15)] bg-surface-cream">
          <div className="relative aspect-[3/4] overflow-hidden bg-secondary-container/40">
            <video 
