              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between gap-4 w-full">
                    ...
                    <span className={\shrink-0 mt-2 transition-opacity duration-300 \\}>
            ...
            <div className="relative w-full h-[75svh] flex items-center justify-center">
              {SERVICES_DATA.map((service, index) => {
                ...
                return (
                  <div
                    key={service.id}
                    className={\bsolute inset-0 flex items-center justify-center transition-opacity duration-700 ease-in-out \\}
                  >
                    {service.media.type === 'video' ? (
                      <video
                        src={service.media.src}
...
fs.writeFileSync('src/components/home/ServicesSection.tsx', code);
